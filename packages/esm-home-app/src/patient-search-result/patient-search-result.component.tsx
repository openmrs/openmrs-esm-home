...
import { interpolateString, ConfigurableLink, ExtensionSlot, useConfig } from '@openmrs/esm-framework';
import { SearchedPatient } from '../types';

const PatientSearchResults: React.FC<PatientSearchResultsProps> = ({ patients }) => {
