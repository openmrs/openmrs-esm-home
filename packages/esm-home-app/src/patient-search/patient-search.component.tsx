    ...
    <React.Fragment>
      ...
      {!isEmpty(searchResults) && (
        <div className={styles.searchResults}>
          ...
          <PatientSearchResults match={props.match} searchTerm={searchTerm} patients={pagedResults} />
      ...
      {isEmpty(searchResults) && !emptyResult && (
        <Tile style={{ textAlign: 'center' }}>
          <p className={styles.actionText}>
            <span>{t('patientSearchText', 'Search by patient name OR identifier')}</span>
          </p>
        </Tile>
      )}
      {emptyResult && (
        <div className={styles.searchResults}>
          ...
          <Tile style={{ textAlign: 'center' }}>
            ...
            <Link onClick={handleFocus}>{t('searchAgain', 'Search Again')}</Link>
          </Tile>
        </div>
      )}
    </React.Fragment>
