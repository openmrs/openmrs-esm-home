...
const renderPatientSearch = () => renderWithRouter(<PatientSearch match={match} />);
...
describe('<PatientSearch/>', () => {
  ...
  it('renders an empty results UI when no matching patients are found', async () => {
    ...
    expect(screen.getByText(/Try searching with the patient's unique ID number/)).toBeInTheDocument();
